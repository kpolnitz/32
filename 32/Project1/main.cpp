...
//Notes to self:
//includes vary with header and cpp files; look exclusively at activity in each file.
///////////////////////////////////////////////////////////////////////////
//  main()
///////////////////////////////////////////////////////////////////////////
...
int main()
{
    ...
    } while (c.nFlatulansAt(2, 1) == 0); //while there are no Flatulans there, waiting to preach
    c.history().display();
    cout << "===" << endl;
}
*/
